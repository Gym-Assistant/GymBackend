...
namespace GymBackend.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20230613202449_AddedEmptyCaloriesDefaultCharacteristic")]
    partial class AddedEmptyCaloriesDefaultCharacteristic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FoodBackend.Domain.Foodstuffs.FoodCharacteristicType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("9fe9959f-7c51-479e-8138-43950064712e"),
                            IsDefault = true,
                            Name = "Пустые Калории"
                        },
                        new
